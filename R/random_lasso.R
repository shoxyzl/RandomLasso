...
#' linear
#'
#' linear is used to fit linear models
...
#' logistic
#'
#' logistic is used to fit logistic models
#' @param X independent variable(s)
#' @param y dependent variable
#'
#' @return
...
#' @examples
#' # continuous
#' lasso(mtcars[,-1],mtcars[,1])
#'
#' # binary
#' lasso(X=dat[,-1],y=dat[,1],continuous=F)
...
#' ridge
#'
#' Fit a generalized linear model by ridge regression.
#' Can deal with continuous and binary dependent variable Y.
#' @param X independent variable
#' @param y dependent variable
#' @param continuous whether the dependent variable is continuous. Default is true.
...
#' @examples
#' # continuous
#' ridge(X = mtcars[,-1], y = mtcars[,1])
#'
#' # binary
#' rigde(X=dat[,-1],y=dat[,1],continuous=F)
